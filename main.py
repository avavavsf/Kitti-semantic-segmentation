...
def gen_test_output_video(sess, logits, keep_prob, image_pl, video_file, image_shape):
    ...
    while True:
        ...
        cv2.imwrite("./video_test/image%08d.jpg"%counter,np.array(street_im_full))
        counter=counter+1
...
def run():
    ...
    with tf.Session() as sess:
        ...
        #save the model
        save_path = saver.save(sess, "/home/yunming/Desktop/CarND-Semantic-Segmentation-master/model.ckpt")
...
if __name__ == '__main__':
    ...
    if train_bool:
        ...
        # launch the model being train before
        init = tf.initialize_all_variables()
        
        sess.run(init)
        saver = tf.train.Saver()
        # Restore variables from disk.
        saver.restore(sess, "/home/yunming/Desktop/CarND-Semantic-Segmentation-master/model.ckpt")
        print("Model restored.")
        # inference on test images
        #helper.save_inference_samples(runs_dir, data_dir, sess, image_shape, logits, keep_prob, input_image)
        # pply the trained model to a video
